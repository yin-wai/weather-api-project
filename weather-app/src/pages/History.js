      ...
      {!locations ?
        <div>
          <form onSubmit={handleSubmit}>
            <div>
              <input  placeholder="Choose your location" name="location" value={formSubmit.location} onChange={handleLocationChange}/>
              <input type="date" name="date" value={formSubmit.date} onChange={handleLocationChange} />
        ...
        <div className='history-result'>
            <p>
            In {locations.name}, on the {formSubmit.date}, at {formSubmit.time}:00 the weather was {timeCondition.toLocaleLowerCase()} with a temperature of {timeTemperature} degree celsius. 
           </p>
